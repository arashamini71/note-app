...
import 'package:firebase_ddd_project_temp/infrastructure/core/firestore_helper.dart';
import 'package:firebase_ddd_project_temp/infrastructure/note/note_dtos.dart';
...
class NoteRepository implements INoteRepository {
  ...
  Stream<Either<NoteFailure, KtList<Note>>> watchAll() async* {
    ...
    yield* userDoc.noteCollection
        ...
        .onErrorReturnWith(
      (e) {
        if (e is PlatformException && e.code.contains('PERMISSION_DENIED')) {
          return left(const NoteFailure.insufficientPermission());
        } else {
          return left(const NoteFailure.unexpected());
        }
