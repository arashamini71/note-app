...
// ignore: unused_element
  _NotesRecived notesRecived(Either<NoteFailure, KtList<Note>> failureOrNotes) {
    return _NotesRecived(
      failureOrNotes,
    );
  }
}
...
mixin _$NoteWatcherEvent {
  ...
  TResult when<TResult extends Object>({
    ...
    @required
        TResult notesRecived(Either<NoteFailure, KtList<Note>> failureOrNotes),
  });
  @optionalTypeArgs
...
/// @nodoc
abstract class _$NotesRecivedCopyWith<$Res> {
  factory _$NotesRecivedCopyWith(
          _NotesRecived value, $Res Function(_NotesRecived) then) =
      __$NotesRecivedCopyWithImpl<$Res>;
  $Res call({Either<NoteFailure, KtList<Note>> failureOrNotes});
}

/// @nodoc
class __$NotesRecivedCopyWithImpl<$Res>
    extends _$NoteWatcherEventCopyWithImpl<$Res>
    implements _$NotesRecivedCopyWith<$Res> {
  __$NotesRecivedCopyWithImpl(
      _NotesRecived _value, $Res Function(_NotesRecived) _then)
      : super(_value, (v) => _then(v as _NotesRecived));

  @override
  _NotesRecived get _value => super._value as _NotesRecived;

  @override
  $Res call({
    Object failureOrNotes = freezed,
  }) {
    return _then(_NotesRecived(
...
/// @nodoc
class _$_NotesRecived implements _NotesRecived {
  const _$_NotesRecived(this.failureOrNotes) : assert(failureOrNotes != null);
  ...
  @override
  String toString() {
    return 'NoteWatcherEvent.notesRecived(failureOrNotes: $failureOrNotes)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _NotesRecived &&
  ...
  @JsonKey(ignore: true)
  @override
  _$NotesRecivedCopyWith<_NotesRecived> get copyWith =>
      __$NotesRecivedCopyWithImpl<_NotesRecived>(this, _$identity);
  ...
  TResult when<TResult extends Object>({
    ...
    assert(watchUncompletedStarted != null);
    assert(notesRecived != null);
    return notesRecived(failureOrNotes);
  }
...
abstract class _NotesRecived implements NoteWatcherEvent {
  const factory _NotesRecived(
      Either<NoteFailure, KtList<Note>> failureOrNotes) = _$_NotesRecived;
